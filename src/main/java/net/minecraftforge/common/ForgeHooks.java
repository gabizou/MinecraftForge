...
import net.minecraftforge.event.old.entity.living.LivingDropsEvent;
import net.minecraftforge.event.old.entity.living.LivingEvent.LivingJumpEvent;
import net.minecraftforge.event.old.entity.living.LivingEvent.LivingUpdateEvent;
import net.minecraftforge.event.old.entity.living.LivingFallEvent;
import net.minecraftforge.event.old.entity.living.LivingHurtEvent;
import net.minecraftforge.event.old.entity.living.LivingKnockBackEvent;
import net.minecraftforge.event.old.entity.living.LivingSetAttackTargetEvent;
import net.minecraftforge.event.old.entity.living.LootingLevelEvent;
import net.minecraftforge.event.old.entity.player.AnvilRepairEvent;
import net.minecraftforge.event.old.entity.player.AttackEntityEvent;
...
import net.minecraftforge.event.old.entity.player.PlayerInteractEvent;
import net.minecraftforge.event.old.entity.player.AdvancementEvent;
import net.minecraftforge.event.old.world.BlockEvent;
import net.minecraftforge.event.old.world.NoteBlockEvent;
...
public class ForgeHooks
{
    ...
    {
        UpdateAnvilEvent e = new UpdateAnvilEvent(left, right, name, baseCost);
