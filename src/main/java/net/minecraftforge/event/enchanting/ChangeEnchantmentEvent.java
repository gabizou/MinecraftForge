 ...
 */
public class ChangeEnchantmentEvent extends Event
{
    ...
    public ChangeEnchantmentEvent(Cause cause, World world, BlockPos pos, int enchantRow, int power, @Nonnull ItemStack itemStack, int level)
    {
        super(cause);
        this.world = world;
        this.pos = pos;
